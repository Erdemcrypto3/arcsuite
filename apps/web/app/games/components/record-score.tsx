...
import { useAccount, useSendTransaction, useWaitForTransactionReceipt } from '@arcsuite/wallet';
...
export function RecordScore({ gameId, score }: Props) {
    ...
    return (
      <div className="mt-3 text-center">
        ...
        <a
          ...
          className="ml-2 text-xs text-arc-500 underline hover:text-arc-600"
        >
          View tx
        </a>
      </div>
  ...
  return (
    <button
      ...
      className="mt-3 rounded-lg bg-arc-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-arc-600 disabled:opacity-50 disabled:cursor-wait"
    >
