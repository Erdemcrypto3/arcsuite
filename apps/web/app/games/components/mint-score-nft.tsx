...
import { useAccount, useWriteContract } from '@arcsuite/wallet';
...
export function MintScoreNFTButton({ gameId, gameTitle, gameIcon, score }: Props) {
  ...
  <text x='200' y='370' font-size='14' font-family='monospace' text-anchor='middle' fill='#C4B5FD'>${shortAddr}</text>
      ...
      const metadata = {
        ...
        description: `${gameIcon} ${gameTitle} score of ${score} by ${shortAddr} on Arc Game Hub. Minted ${dateLabel}.`,
        image: imgData.url,
        attributes: [
  ...
  return (
    <div className="mt-3 flex flex-col items-center gap-1">
      <button
        ...
        className="rounded-lg bg-arc-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-arc-600 disabled:opacity-50 disabled:cursor-wait"
      >
