  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <div className="flex items-center gap-6 text-sm">
        <span className="text-arc-700">Score: <span className="font-mono text-arc-900">{score}</span></span>
        <span className="text-arc-700">Best: <span className="font-mono text-arc-500">{highScore}</span></span>
      </div>
      ...
      <div className="relative">
        ...
        {gameState === 'idle' && (
          <div className="absolute inset-0 flex items-center justify-center rounded-lg bg-white/90">
            <button onClick={startGame} className="rounded-lg bg-arc-500 px-8 py-3 text-sm font-semibold text-white hover:bg-arc-700">
              Start Game
            </button>
          </div>
        )}
        {gameState === 'over' && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 rounded-lg bg-white/90">
            ...
            <div className="font-mono text-2xl text-arc-900">{score} pts</div>
      ...
      <p className="text-xs text-arc-500">Arrow keys or WASD to move.</p>
    </div>
  );
}
