...
import { ArcWalletProvider, ConnectButton } from '@arcsuite/wallet';
  ...
  if (loading) {
    return (
      <main className="mx-auto max-w-7xl px-6 py-16">
        <div className="py-24 text-center text-arc-600">Loading Premier League data…</div>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-10">
      <header className="mb-8">
        ...
        <p className="mt-3 max-w-2xl text-base leading-relaxed text-arc-700">
        ...
        <p className="mt-1 text-xs text-arc-400">
      ...
      <footer className="mt-16 border-t border-purple-200 pt-8 text-sm text-arc-500">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <span>Part of Arc Suite · MIT license · Player data from FPL</span>
          <a
