...
const SVGS: Record<string, () => React.ReactElement> = {
  ...
  rectangle_8_3: () => (
    <svg viewBox="0 0 220 120" className="h-24 w-44">
      <rect x="20" y="20" width="160" height="60" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* right angle markers */}
  ...
  square_s7: () => (
    <svg viewBox="0 0 180 180" className="h-32 w-32">
      <rect x="30" y="30" width="120" height="120" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* right angle markers */}
  ...
  triangle_base6_height4: () => (
    <svg viewBox="0 0 200 150" className="h-32 w-40">
      <polygon points="20,130 180,130 100,20" fill="none" stroke="#0066FF" strokeWidth="2" />
  ...
  triangle_angles_sum: () => (
    <svg viewBox="0 0 220 160" className="h-32 w-44">
      <polygon points="110,10 20,150 200,150" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* angle arcs */}
      ...
      <text x="110" y="175" textAnchor="middle" fill="#0066FF" fontSize="13" fontFamily="monospace" fontWeight="bold">α+β+γ = 180°</text>
    </svg>
  ),
  ...
  circle_r5: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <circle cx="100" cy="100" r="70" fill="none" stroke="#0066FF" strokeWidth="2" />
      ...
      <circle cx="100" cy="100" r="3" fill="#0066FF" />
    </svg>
  ),
  ...
  right_angle_90: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <line x1="30" y1="170" x2="170" y2="170" stroke="#0066FF" strokeWidth="2" />
      <line x1="30" y1="170" x2="30" y2="30" stroke="#0066FF" strokeWidth="2" />
      ...
      <text x="66" y="148" fill="#0066FF" fontSize="14" fontFamily="monospace" fontWeight="bold">90°</text>
    </svg>
  ),
  ...
  square_s9_area: () => (
    <svg viewBox="0 0 180 180" className="h-32 w-32">
      <rect x="20" y="20" width="140" height="140" fill="#ede9fe" stroke="#0066FF" strokeWidth="2" />
      {/* right angle marker */}
      <polyline points="20,40 36,40 36,20" fill="none" stroke="#a78bfa" strokeWidth="1" />
      <text x="90" y="12" textAnchor="middle" fill="#3b1d6e" fontSize="12" fontFamily="monospace">s = 9 cm</text>
      <text x="90" y="95" textAnchor="middle" fill="#0066FF" fontSize="13" fontFamily="monospace" fontWeight="bold">A = s²</text>
  ...
  rectangle_10_4: () => (
    <svg viewBox="0 0 240 120" className="h-24 w-48">
      <rect x="20" y="20" width="200" height="80" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* right angle markers */}
      <polyline points="20,40 36,40 36,20" fill="none" stroke="#a78bfa" strokeWidth="1" />
  ...
  right_triangle_3_4: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <polygon points="20,180 160,180 20,60" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* right angle marker */}
      ...
      <text x="102" y="115" fill="#0066FF" fontSize="13" fontFamily="monospace" fontWeight="bold">c = ?</text>
    </svg>
  ),
  ...
  circle_r7: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <circle cx="100" cy="100" r="80" fill="#ede9fe" stroke="#0066FF" strokeWidth="2" />
      ...
      <circle cx="100" cy="100" r="3" fill="#0066FF" />
      <text x="100" y="140" textAnchor="middle" fill="#0066FF" fontSize="12" fontFamily="monospace">A = πr²</text>
    </svg>
  ),
  ...
  triangle_angles_55_75: () => (
    <svg viewBox="0 0 220 170" className="h-32 w-44">
      <polygon points="110,15 15,155 205,155" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* angle arcs */}
      ...
      {/* angle labels */}
      <text x="110" y="58" textAnchor="middle" fill="#0066FF" fontSize="12" fontFamily="monospace" fontWeight="bold">?°</text>
  ...
  rectangle_area60_w5: () => (
    <svg viewBox="0 0 240 120" className="h-24 w-48">
      <rect x="20" y="20" width="200" height="80" fill="#ede9fe" stroke="#0066FF" strokeWidth="2" />
      <polyline points="20,40 36,40 36,20" fill="none" stroke="#a78bfa" strokeWidth="1" />
      ...
      <text x="120" y="65" textAnchor="middle" fill="#0066FF" fontSize="12" fontFamily="monospace" fontWeight="bold">A = 60 cm²</text>
    </svg>
  ),
  ...
  trapezoid_8_12_h5: () => (
    <svg viewBox="0 0 260 150" className="h-28 w-52">
      ...
      <polygon points="30,120 230,120 196,30 64,30" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* height dashed line */}
  ...
  right_triangle_5_13: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <polygon points="20,180 140,180 20,60" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* right angle marker */}
      <polyline points="20,180 20,164 36,164" fill="none" stroke="#a78bfa" strokeWidth="2" />
      <text x="80" y="196" textAnchor="middle" fill="#3b1d6e" fontSize="12" fontFamily="monospace">a = 5 cm</text>
      <text x="4" y="125" textAnchor="middle" fill="#0066FF" fontSize="12" fontFamily="monospace" fontWeight="bold" transform="rotate(-90,4,125)">b = ?</text>
  ...
  equilateral_triangle_s6: () => (
    <svg viewBox="0 0 200 180" className="h-32 w-36">
      <polygon points="100,10 20,170 180,170" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* 60° angle markers */}
  ...
  sphere_r3: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      {/* outer circle */}
      <circle cx="100" cy="100" r="75" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* equator ellipse */}
  ...
  circle_inscribed_square_10: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      {/* square */}
      <rect x="20" y="20" width="160" height="160" fill="#ede9fe" stroke="#0066FF" strokeWidth="2" />
      {/* inscribed circle */}
      <circle cx="100" cy="100" r="80" fill="white" stroke="#0066FF" strokeWidth="2" />
      {/* right angle marker */}
      <polyline points="20,40 36,40 36,20" fill="none" stroke="#a78bfa" strokeWidth="1" />
      {/* radius line */}
      <line x1="100" y1="100" x2="180" y2="100" stroke="#a78bfa" strokeWidth="1.5" />
  ...
  cone_r4_h9: () => (
    <svg viewBox="0 0 200 220" className="h-36 w-32">
      {/* base ellipse */}
      <ellipse cx="100" cy="175" rx="70" ry="22" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* sides */}
      <line x1="100" y1="30" x2="30" y2="175" stroke="#0066FF" strokeWidth="2" />
      <line x1="100" y1="30" x2="170" y2="175" stroke="#0066FF" strokeWidth="2" />
      {/* height dashed line */}
  ...
  circle_chord_r10_d6: () => (
    <svg viewBox="0 0 220 220" className="h-36 w-36">
      <circle cx="110" cy="110" r="90" fill="none" stroke="#0066FF" strokeWidth="2" />
      ...
      {/* chord */}
      <line x1="42" y1="56" x2="178" y2="56" stroke="#0066FF" strokeWidth="2.5" />
      {/* radius to chord end */}
      <line x1="110" y1="110" x2="178" y2="56" stroke="#a78bfa" strokeWidth="1.5" />
      {/* center dot */}
      <circle cx="110" cy="110" r="3" fill="#0066FF" />
      {/* labels */}
      ...
      <text x="110" y="50" textAnchor="middle" fill="#0066FF" fontSize="12" fontFamily="monospace" fontWeight="bold">chord = ?</text>
    </svg>
  ),
  ...
  cylinder_r5_h12: () => (
    <svg viewBox="0 0 180 240" className="h-40 w-28">
      {/* top ellipse */}
      <ellipse cx="90" cy="40" rx="60" ry="20" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* sides */}
      <line x1="30" y1="40" x2="30" y2="185" stroke="#0066FF" strokeWidth="2" />
      <line x1="150" y1="40" x2="150" y2="185" stroke="#0066FF" strokeWidth="2" />
      {/* bottom ellipse */}
      <ellipse cx="90" cy="185" rx="60" ry="20" fill="none" stroke="#0066FF" strokeWidth="2" />
      {/* radius line on top */}
  ...
  cube_5: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <rect x="30" y="50" width="100" height="100" fill="none" stroke="#0066FF" strokeWidth="2" />
      <polygon points="30,50 70,20 170,20 130,50" fill="none" stroke="#0066FF" strokeWidth="1.5" />
      <line x1="130" y1="50" x2="170" y2="20" stroke="#0066FF" strokeWidth="1.5" />
  ...
  cylinder_r3_h7: () => (
    <svg viewBox="0 0 180 220" className="h-36 w-28">
      <ellipse cx="90" cy="40" rx="60" ry="20" fill="none" stroke="#0066FF" strokeWidth="2" />
      <line x1="30" y1="40" x2="30" y2="170" stroke="#0066FF" strokeWidth="2" />
      <line x1="150" y1="40" x2="150" y2="170" stroke="#0066FF" strokeWidth="2" />
      <ellipse cx="90" cy="170" rx="60" ry="20" fill="none" stroke="#0066FF" strokeWidth="2" />
  ...
  angle_45: () => (
    <svg viewBox="0 0 200 200" className="h-32 w-32">
      <line x1="30" y1="170" x2="170" y2="170" stroke="#0066FF" strokeWidth="2" />
      <line x1="30" y1="170" x2="140" y2="40" stroke="#0066FF" strokeWidth="2" />
      <path d="M 60,170 A 30,30 0 0,1 52,148" fill="none" stroke="#a78bfa" strokeWidth="1.5" />
      <text x="68" y="158" fill="#0066FF" fontSize="13" fontFamily="monospace" fontWeight="bold">45°</text>
    </svg>
  ),
  parallelogram_b8_h5: () => (
    <svg viewBox="0 0 240 130" className="h-24 w-48">
      <polygon points="50,110 200,110 230,20 80,20" fill="none" stroke="#0066FF" strokeWidth="2" />
